...
<body>
  ...
  <section id="clientes" class="fadein client">
    <article>
      <img src="imagenes/rs.png" class="imgcli" alt="">
    </article>
    <article>
      <img src="imagenes/clinum.jpg" class="imgcli" alt="">
    </article>
    <article>
      <img src="imagenes/odels.jpg" class="imgcli" alt="">
    </article>
    <article>
      <img src="imagenes/kintec.jpg" class="imgcli" alt="">
    </article>
    <article>
      <img src="imagenes/dreams.jpg" class="imgcli" alt="">
    </article>
    <article>
      <img src="imagenes/medusas.png" class="imgcli" alt="">
    </article>
  </section>
